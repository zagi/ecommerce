<?php namespace Modules\Manufacturer\Providers;
...
class ManufacturerServiceProvider extends ServiceProvider {
	...
	public function registerViews()
	{
		...
		$this->loadViewsFrom([$viewPath, $sourcePath], 'manufacturer');
	}
	...
	public function registerTranslations()
	{
		...
		if (is_dir($langPath)) {
			...
			$this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'manufacturer');
		}
	}
